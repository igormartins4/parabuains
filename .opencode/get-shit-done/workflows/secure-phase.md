...
```
Task(
  prompt="Read C:/Users/igorsantos/code/parabuains/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/igorsantos/code/parabuains/.opencode/get-shit-done/templates/SECURITY.md`
