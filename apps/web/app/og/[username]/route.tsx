...
export async function GET(
  ...
  // biome-ignore lint/suspicious/noExplicitAny: @vercel/og ImageResponse JSX requires untyped API response
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        {avatarData ? (
          // biome-ignore lint/performance/noImgElement: @vercel/og ImageResponse does not support next/image
          <img src={avatarData} width={120} height={120} style={{ objectFit: 'cover' }} alt="" />
        ) : (
      ...
      {countdownText && (
        ...
        >
          ...
          <span style={{ fontSize: 28, fontWeight: 600, color: '#be185d' }}>{countdownText}</span>
        </div>
      )}
