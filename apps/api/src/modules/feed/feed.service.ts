...
export class FeedService {
  ...
  buildBirthdayEntry(candidate: BirthdayCandidate, now: DateTime): BirthdayEntry | null {
    ...
    return {
      ...
      // biome-ignore lint/style/noNonNullAssertion: Luxon toISODate() returns null only for invalid dates; nextBirthday is always valid here
